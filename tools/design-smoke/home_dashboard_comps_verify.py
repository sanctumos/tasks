#!/usr/bin/env python3
"""
Screenshot home dashboard element comps (mobile + desktop).
Ephemeral php -S child — always killed in finally.
  python3 tools/design-smoke/home_dashboard_comps_verify.py
"""
...
COMPS = Path(__file__).resolve().parent / "home-dashboard-comps"
OUT = Path(__file__).resolve().parent / "output" / "home-dashboard-comps"
VIEWPORTS = [
    ("mobile", {"width": 390, "height": 844}),
    ("desktop", {"width": 1280, "height": 900}),
]
SECTIONS = ["comp-a", "comp-b", "comp-c", "comp-d", "comp-e", "comp-f", "comp-rec"]
