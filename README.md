...
- Optional canonical app origin for absolute pagination links and **`public_share_url`** on directory documents:
  - `TASKS_APP_BASE_URL` (for example `https://tasks.example.com`) — falls back to inferred request origin when unset
